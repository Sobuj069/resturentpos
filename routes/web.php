...
Route::get('/our-service', [LandingController::class, 'services'])->name('our-service');
...
// 4. Public QR Code Table Self-Ordering (No auth required for dining customers)
...
// ═══════════════════════════════════════════════════════════════
// AUTHENTICATED STAFF & RESTAURANT MANAGEMENT ROUTES
// ═══════════════════════════════════════════════════════════════
