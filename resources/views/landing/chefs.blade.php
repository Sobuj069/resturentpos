...
@section('content')
    ...
    <section class="py-24 bg-[#0B0B0B] relative">
        <div class="max-w-7xl mx-auto px-6 sm:px-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                ...
                <!-- Chef 1 -->
                <div class="rounded-2xl overflow-hidden border border-[#C5A880]/20 group shadow-xl">
                    <img src="https://images.unsplash.com/photo-1577219491135-ce391730fb2c?auto=format&fit=crop&w=600&q=80" 
                         alt="Chef" class="w-full h-80 object-cover group-hover:scale-105 transition-transform duration-500">
                </div>

                <!-- Chef 2 (Active/Hover Card matching screenshot) -->
                <div class="bg-[#D1A568] rounded-2xl p-8 chamfer-top-right flex flex-col items-center justify-center text-center text-black shadow-2xl">
                ...
                <div class="rounded-2xl overflow-hidden border border-[#C5A880]/20 group shadow-xl">
                    <img src="https://images.unsplash.com/photo-1581299894007-aaa50297cf16?auto=format&fit=crop&w=600&q=80" 
                         alt="Pastry Chef" class="w-full h-80 object-cover group-hover:scale-105 transition-transform duration-500">
                </div>

                <!-- Chef 5 -->
                <div class="rounded-2xl overflow-hidden border border-[#C5A880]/20 group shadow-xl">
                    <img src="https://images.unsplash.com/photo-1566554273541-37a9ca77b91f?auto=format&fit=crop&w=600&q=80" 
                         alt="Grill Chef" class="w-full h-80 object-cover group-hover:scale-105 transition-transform duration-500">
                </div>

                <!-- Chef 6 -->
                <div class="rounded-2xl overflow-hidden border border-[#C5A880]/20 group shadow-xl">
                    <img src="https://images.unsplash.com/photo-1607631568010-a87245c0daf8?auto=format&fit=crop&w=600&q=80" 
                         alt="Master Chef" class="w-full h-80 object-cover group-hover:scale-105 transition-transform duration-500">
                </div>
    ...
    <section class="py-20 bg-[#0E0E0E] border-t border-[#C5A880]/15 relative">
        <div class="max-w-7xl mx-auto px-6 sm:px-10">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                ...
                <div class="lg:col-span-6 bg-white text-[#1A1A1A] p-8 sm:p-10 chamfer-top-right shadow-2xl space-y-6">
    ...
    <section class="py-20 bg-[#0B0B0B] border-t border-[#C5A880]/15">
        <div class="max-w-7xl mx-auto px-6 sm:px-10">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-[#111111] p-8 sm:p-12 rounded-3xl border border-[#C5A880]/20">
                <div class="lg:col-span-6 space-y-4">
                    ...
                    <div class="pt-2">
                        <a href="{{ route('reservation') }}" class="inline-block px-8 py-3 rounded bg-[#D1A568] hover:bg-[#C5A880] text-black font-bold text-xs uppercase tracking-wider transition-all">
                            BOOK A TABLE
                        </a>
                    </div>
                </div>
