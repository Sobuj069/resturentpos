...
@section('content')
    ...
    <!-- ════ 1. FEATURED TOP NEWS SECTION (MATCHING SCREENSHOT) ════ -->
    <section class="py-24 bg-[#0B0B0B] relative">
        <div class="max-w-7xl mx-auto px-6 sm:px-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div class="lg:col-span-7 bg-[#141414] rounded-3xl border border-[#C5A880]/20 overflow-hidden shadow-2xl group">
                    <div class="relative h-80 overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1556910103-1c02745aae4d?auto=format&fit=crop&w=1000&q=80" 
                             alt="Featured News" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                    </div>
                ...
                <div class="lg:col-span-5 space-y-4">
                    ...
                    <div class="bg-[#141414] p-4 rounded-2xl border border-[#C5A880]/20 flex gap-4 items-center group hover:border-[#C5A880] transition-all">
                        <img src="https://images.unsplash.com/photo-1577219491135-ce391730fb2c?auto=format&fit=crop&w=300&q=80" alt="Chefs" class="w-24 h-24 rounded-xl object-cover shrink-0">
                        <div class="space-y-1">
                    ...
                    <div class="bg-[#141414] p-4 rounded-2xl border border-[#C5A880]/20 flex gap-4 items-center group hover:border-[#C5A880] transition-all">
                        <img src="https://images.unsplash.com/photo-1589302168068-964664d93dc0?auto=format&fit=crop&w=300&q=80" alt="Rice" class="w-24 h-24 rounded-xl object-cover shrink-0">
                        <div class="space-y-1">
                    ...
                    <div class="bg-[#141414] p-4 rounded-2xl border border-[#C5A880]/20 flex gap-4 items-center group hover:border-[#C5A880] transition-all">
                        <img src="https://images.unsplash.com/photo-1550966871-3ed3cdb5ed0c?auto=format&fit=crop&w=300&q=80" alt="Dining" class="w-24 h-24 rounded-xl object-cover shrink-0">
                        <div class="space-y-1">
    ...
    <section class="py-20 bg-[#0E0E0E] border-t border-[#C5A880]/15 text-center">
    ...
    <section class="py-24 bg-[#0B0B0B] border-t border-[#C5A880]/15">
        <div class="max-w-7xl mx-auto px-6 sm:px-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <!-- Recipe 1 -->
                <div class="bg-[#141414] rounded-3xl border border-[#C5A880]/20 overflow-hidden group">
                    ...
                    <div class="h-60 overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1547592180-85f173990554?auto=format&fit=crop&w=800&q=80" alt="Soup" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                    </div>
                    <div class="p-6">
                ...
                <div class="bg-[#141414] rounded-3xl border border-[#C5A880]/20 overflow-hidden group">
                    ...
                    <div class="h-60 overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1565299585323-38d6b0865b47?auto=format&fit=crop&w=800&q=80" alt="Pancake" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                    </div>
                    <div class="p-6">
                        <p class="text-xs text-[#8C7D73] leading-relaxed mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        <a href="{{ route('our-menu') }}" class="text-xs font-bold text-[#C5A880] hover:underline">Read More →</a>
                ...
                <div class="bg-[#141414] rounded-3xl border border-[#C5A880]/20 overflow-hidden group">
                    ...
                    <div class="h-60 overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1540420773420-3366772f4999?auto=format&fit=crop&w=800&q=80" alt="Salad" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                    </div>
                    <div class="p-6">
                        <p class="text-xs text-[#8C7D73] leading-relaxed mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        <a href="{{ route('our-menu') }}" class="text-xs font-bold text-[#C5A880] hover:underline">Read More →</a>
                ...
                <div class="bg-[#141414] rounded-3xl border border-[#C5A880]/20 overflow-hidden group">
                    ...
                    <div class="h-60 overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=800&q=80" alt="Chicken" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                    </div>
                    <div class="p-6">
                        <p class="text-xs text-[#8C7D73] leading-relaxed mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        <a href="{{ route('our-menu') }}" class="text-xs font-bold text-[#C5A880] hover:underline">Read More →</a>
