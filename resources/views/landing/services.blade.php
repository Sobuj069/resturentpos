    ...
    <section class="py-24 bg-[#0B0B0B] relative">
        <div class="max-w-7xl mx-auto px-6 sm:px-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <!-- Card 1: Noodle -->
                <div class="bg-[#141414] p-7 chamfer-top-right border border-[#C5A880]/20 space-y-4 group hover:border-[#C5A880] transition-all">
                    <div class="w-12 h-12 rounded-xl flex items-center justify-center border border-[#C5A880]/30" style="background: rgba(197,168,128,0.08);">
                    ...
                    <a href="{{ route('our-menu') }}" class="inline-flex items-center gap-1 text-[11px] font-bold uppercase tracking-wider text-[#C5A880]">
                        <span>View More</span>
                ...
                <!-- Card 3: Cake (Active Gold Sand Card #D1A568 matching screenshot) -->
                <div class="bg-[#D1A568] p-7 chamfer-top-right text-black space-y-4 shadow-2xl">
                    ...
                    <a href="{{ route('our-menu') }}" class="inline-flex items-center gap-1 text-[11px] font-bold uppercase tracking-wider text-black font-bold">
                        <span>View More</span>
                        <i data-lucide="arrow-right" class="w-3.5 h-3.5"></i>
                    </a>
                </div>
