    ...
    <footer class="bg-[#080808] text-[#8C7D73] pt-14 pb-8">
        <div class="max-w-7xl mx-auto px-6 sm:px-10 grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
            ...
            <div class="space-y-3">
                ...
                <!-- Real Vector SVG Social Media Icons -->
                <div class="flex flex-wrap items-center gap-2.5 pt-2">
                    <!-- Facebook -->
                    <a href="{{ $contactData['social']['facebook'] ?? 'https://facebook.com' }}" target="_blank" rel="noopener noreferrer" 
                       class="w-8 h-8 rounded-full border border-[#C5A880]/30 bg-[#141414] flex items-center justify-center text-[#1877F2] hover:bg-[#1877F2] hover:text-white hover:border-[#1877F2] transition-all transform hover:-translate-y-1 shadow-md" title="Facebook">
                    ...
                    <a href="{{ $contactData['social']['instagram'] ?? 'https://instagram.com' }}" target="_blank" rel="noopener noreferrer" 
                       class="w-8 h-8 rounded-full border border-[#C5A880]/30 bg-[#141414] flex items-center justify-center text-[#E4405F] hover:bg-gradient-to-tr hover:from-[#F58529] hover:via-[#DD2A7B] hover:to-[#8134AF] hover:text-white hover:border-transparent transition-all transform hover:-translate-y-1 shadow-md" title="Instagram">
                    ...
                    <a href="{{ $contactData['social']['tiktok'] ?? 'https://tiktok.com' }}" target="_blank" rel="noopener noreferrer" 
                       class="w-8 h-8 rounded-full border border-[#C5A880]/30 bg-[#141414] flex items-center justify-center text-white hover:bg-black hover:text-[#25F4EE] hover:border-[#25F4EE] transition-all transform hover:-translate-y-1 shadow-md" title="TikTok">
                    ...
                    <a href="{{ $contactData['social']['linkedin'] ?? 'https://linkedin.com' }}" target="_blank" rel="noopener noreferrer" 
                       class="w-8 h-8 rounded-full border border-[#C5A880]/30 bg-[#141414] flex items-center justify-center text-[#0A66C2] hover:bg-[#0A66C2] hover:text-white hover:border-[#0A66C2] transition-all transform hover:-translate-y-1 shadow-md" title="LinkedIn">
                    ...
                    <a href="{{ $contactData['social']['twitter'] ?? 'https://twitter.com' }}" target="_blank" rel="noopener noreferrer" 
                       class="w-8 h-8 rounded-full border border-[#C5A880]/30 bg-[#141414] flex items-center justify-center text-white hover:bg-white hover:text-black hover:border-white transition-all transform hover:-translate-y-1 shadow-md" title="X (Twitter)">
                    ...
                    <a href="{{ $contactData['social']['youtube'] ?? 'https://youtube.com' }}" target="_blank" rel="noopener noreferrer" 
                       class="w-8 h-8 rounded-full border border-[#C5A880]/30 bg-[#141414] flex items-center justify-center text-[#FF0000] hover:bg-[#FF0000] hover:text-white hover:border-[#FF0000] transition-all transform hover:-translate-y-1 shadow-md" title="YouTube">
                    ...
                    <a href="{{ $contactData['social']['whatsapp'] ?? 'https://wa.me/62898245124' }}" target="_blank" rel="noopener noreferrer" 
                       class="w-8 h-8 rounded-full border border-[#C5A880]/30 bg-[#141414] flex items-center justify-center text-[#25D366] hover:bg-[#25D366] hover:text-white hover:border-[#25D366] transition-all transform hover:-translate-y-1 shadow-md" title="WhatsApp">
