...
class RestaurantSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // 5. Raw Ingredients
        $ingRice = Ingredient::create(['branch_id' => $branch->id, 'name' => 'Basmati Rice (বাসমতি চাল)', 'unit' => 'kg', 'current_stock' => 85.500, 'alert_stock' => 15.000, 'cost_per_unit' => 140.00]);
        $ingMutton = Ingredient::create(['branch_id' => $branch->id, 'name' => 'Fresh Mutton (খাসির মাংস)', 'unit' => 'kg', 'current_stock' => 42.000, 'alert_stock' => 10.000, 'cost_per_unit' => 1100.00]);
        $ingChicken = Ingredient::create(['branch_id' => $branch->id, 'name' => 'Broiler Chicken (মুরগির মাংস)', 'unit' => 'kg', 'current_stock' => 55.000, 'alert_stock' => 15.000, 'cost_per_unit' => 220.00]);
        $ingBeef = Ingredient::create(['branch_id' => $branch->id, 'name' => 'Boneless Beef (গরুর মাংস)', 'unit' => 'kg', 'current_stock' => 38.000, 'alert_stock' => 10.000, 'cost_per_unit' => 800.00]);
        $ingGhee = Ingredient::create(['branch_id' => $branch->id, 'name' => 'Pure Ghee (গাওয়া ঘি)', 'unit' => 'kg', 'current_stock' => 18.200, 'alert_stock' => 5.000, 'cost_per_unit' => 1200.00]);
        $ingMustardOil = Ingredient::create(['branch_id' => $branch->id, 'name' => 'Mustard Oil (সরিষার তেল)', 'unit' => 'litre', 'current_stock' => 25.000, 'alert_stock' => 5.000, 'cost_per_unit' => 280.00]);
        $ingYogurt = Ingredient::create(['branch_id' => $branch->id, 'name' => 'Sour Curd / Yogurt (টক দই)', 'unit' => 'kg', 'current_stock' => 30.000, 'alert_stock' => 8.000, 'cost_per_unit' => 180.00]);
        $ingFlour = Ingredient::create(['branch_id' => $branch->id, 'name' => 'Maida Flour (ময়দা)', 'unit' => 'kg', 'current_stock' => 60.000, 'alert_stock' => 15.000, 'cost_per_unit' => 65.00]);
